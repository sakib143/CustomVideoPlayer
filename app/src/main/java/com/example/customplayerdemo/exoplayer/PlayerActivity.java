package com.example.customplayerdemo.exoplayer;
...
import com.example.customplayerdemo.R;
import com.example.customplayerdemo.exoplayer.model.VideoSource;
import com.example.customplayerdemo.exoplayer.util.PlayerController;
import com.example.customplayerdemo.exoplayer.util.VideoPlayer;
...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener, PlayerController {
    ...
    private ImageButton mute, unMute, setting, lock, unLock, nextBtn, preBtn, retry, back;
